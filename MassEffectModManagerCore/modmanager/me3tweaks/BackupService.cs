...
//            if (logReturnedPath)
//            {
//                M3Log.Information($@" >> Backup path lookup in registry for {game} returned: {path}");
//            }
...
//                if (logReturnedPath)
//                {
//                    M3Log.Information(@" >> Path is null or directory doesn't exist.");
//                }
...
//                    if (logReturnedPath)
//                    {
//                        M3Log.Warning(@" >> " + path + @" is missing Content subdirectory, invalid backup");
//                    }
...
//                if (logReturnedPath)
//                {
//                    M3Log.Warning(@" >> " + path + @" is missing biogame/binaries subdirectory, invalid backup");
//                }
//                GameBackupPathCache[game] = null;
//                return null;
//            }
...
//                if (logReturnedPath)
//                {
//                    M3Log.Warning(@" >> " + path + @" is not marked as a vanilla backup. This backup will not be considered vanilla and thus will not be used by Mod Manager");
//                }
//                GameBackupPathCache[game] = null;
...
//            if (logReturnedPath)
//            {
//                M3Log.Information(@" >> " + path + @" is considered a valid backup path");
//            }
...
//        public static void SetInstallStatuses(ObservableCollectionExtended<GameTargetWPF> installationTargets)
//        {
...
//                if (storedPath != null)
//                {
//                    M3Log.Information(@"Migrating ALOT key backup location for ME1");
...
//                if (storedPath != null)
//                {
//                    M3Log.Information(@"Migrating ALOT key backup location for ME2");
...
//                if (storedPath != null)
//                {
//                    M3Log.Information(@"Migrating ME3CMM key backup location for ME3");
