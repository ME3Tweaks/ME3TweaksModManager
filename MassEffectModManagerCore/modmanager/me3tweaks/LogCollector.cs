...
//        {
//            M3Log.Information(@"Shutting down logger to allow application to pull log file.");
//            M3Log.CloseAndFlush();
//            try
//            {
...
//            {
//                CreateLogger();
//                M3Log.Error(@"Could not read log file! " + e.Message);
//                return null;
//            }
//        }
...
//        {
//            M3Log.Logger = new LoggerConfiguration().WriteTo.SizeRollingFile(Path.Combine(App.LogDir, @"modmanagerlog.txt"),
...
//        //{
//        //    M3Log.Information($@"Running Mass Effect Modder No GUI w/ IPC: {exe} {args}");
...
//        //        {
//        //            M3Log.Fatal(@"MassEffectModderNoGui.exe: " + str);
//        //        }
...
//        public static string PerformDiagnostic(GameTargetWPF selectedDiagnosticTarget, bool textureCheck, Action<string> updateStatusCallback = null, Action<int> updateProgressCallback = null, Action<TaskbarProgressBarState> updateTaskbarState = null)
//        {
//            M3Log.Information($@"Collecting diagnostics for target {selectedDiagnosticTarget.TargetPath}");
...
//                M3Log.Error(@"Failed to acquire MEM for diagnostics.");
//                hasMEM = false;
...
//            }
//            #endregion
//            M3Log.Information(@"Completed MEM fetch task");
...
//            M3Log.Information(@"Beginning to build diagnostic output");
...
//                    else
//                    {
//                        M3Log.Error($@"Invalid game directory: {gamePath} is not part of an overall LE install");
...
//                    {
//                        M3Log.Information(@"Getting additional ME1 executable information");
...
//                    M3Log.Information(@"Checking executable signature");
...
//                    //BINK
//                    M3Log.Information(@"Checking if Bink ASI loader is installed");
...
//                M3Log.Information(@"Collecting system information");
...
//                addDiagLine();
//                M3Log.Information(@"Collecting memory information");
...
//                M3Log.Information(@"Collecting processor information");
...
//                M3Log.Information(@"Collecting video card information");
...
//                M3Log.Information(@"Getting texture mod installation info");
...
//                M3Log.Information(@"Collecting basegame file changes information");
...
//                M3Log.Information(@"Checking for mods that are known to cause problems in the scene");
...
//                M3Log.Information(@"Collecting installed DLC");
...
//                M3Log.Information(@"Collecting supersedance list");
...
//                if (selectedDiagnosticTarget.Game > MEGame.ME1)
//                {
//                    M3Log.Information(@"Getting list of TFCs");
...
//                    M3Log.Information(@"Finding files that have been added/replaced/removed after textures were installed");

//                    args = $@"--check-game-data-mismatch --gameid {gameID} --ipc";
//                    if (selectedDiagnosticTarget.TextureModded)
//                    {
//                        // Is this correct on linux?
//                        M3Log.Information(@"Checking texture map is in sync with game state");
...
//                    if (textureCheck)
//                    {
//                        M3Log.Information(@"Performing full texture check");
//                        var param = 0;
...
//                    #region Texture LODs
//                    M3Log.Information(@"Collecting texture LODs");
...
//                else
//                {
//                    M3Log.Warning(@"MEM not available. Multiple collections were skipped");
...
//                #region ASI mods
//                M3Log.Information(@"Collecting ASI mod information");
...
//                {
//                    M3Log.Information(@"Collecting TOC information");
...
//                    {
//                        M3Log.Information($@"Checking TOC file {toc}");
...
//                if (selectedDiagnosticTarget.Game == MEGame.ME1)
//                {
//                    M3Log.Information(@"Collecting ME1 crash logs");
...
//                                    M3Log.Information(@"Found crash in ME1 log " + file.Name + @" on line " + currentLineNumber);
//                                    break;
//                                }
...
//                //EVENT LOGS
//                M3Log.Information(@"Collecting event logs");
...
//                {
//                    M3Log.Information(@"Collecting ME3Logger session log");
...
//        private static void SeeIfIncompatibleDLCIsInstalled(GameTargetWPF target, Action<string, Severity> addDiagLine)
//        {
...
//        private static void addLODStatusToDiag(GameTargetWPF selectedDiagnosticTarget, Dictionary<string, string> lods, Action<string, Severity> addDiagLine)
//        {
...
//            catch (Exception e)
//            {
//                M3Log.Error(@"Error checking LOD settings: " + e.Message);
...
//                catch (Exception e)
//                {
//                    M3Log.Error($@"Error reading partition type on {partitionLetter}: {e.Message}");
//                    return -1;
//                }
//            }
//        }
...
//            catch (Exception e)
//            {
//                M3Log.Error($@"Error getting processor information: {e.Message}");
