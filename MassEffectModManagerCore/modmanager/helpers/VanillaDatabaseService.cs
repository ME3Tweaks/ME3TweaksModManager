...
//        public static DLCPackage FetchVanillaSFAR(string dlcName, GameTargetWPF target = null)
//        {
...
//                {
//                    M3Log.Error(@"SFAR is not vanilla: " + sfar);
...
//            else
//            {
//                M3Log.Error($@"SFAR does not exist for requested file fetch: {sfar}");
//            }
//            return null;
//        }
...
//        public static MemoryStream FetchFileFromVanillaSFAR(string dlcName, string filename, GameTargetWPF target = null, DLCPackage forcedDLC = null)
//        {
...
//                    M3Log.Error($@"Could not find basegame file (or found multiple) in backup for {game}: {filename}");
...
//            {
//                //ambiguous or file not found
//                M3Log.Error($@"Could not find {filename} DLC file (or found multiple) in backup for {game}: {filename}");
//            }
...
//        public static bool IsFileVanilla(GameTargetWPF target, string file, bool md5check = false)
//        {
...
//        public static bool ValidateTargetAgainstVanilla(GameTargetWPF target, Action<string> failedValidationCallback, bool strictCheck)
//        {
//            bool isVanilla = true;
...
//            else
//            {
//                M3Log.Error(@"Directory to validate doesn't exist: " + target.TargetPath);
//            }
...
//        internal static List<string> GetInstalledOfficialDLC(GameTargetWPF target, bool includeDisabled = false)
//        {
...
//        internal static bool ValidateTargetDLCConsistency(GameTargetWPF target, Action<string> inconsistentDLCCallback = null)
//        {
...
//        public static List<(int size, string md5)> GetVanillaFileInfo(GameTargetWPF target, string filepath)
//        {
//            CaseInsensitiveDictionary<List<(int size, string md5)>> vanillaDB = null;
//            switch (target.Game)
//            {
...
//        internal static (string hash, string result) GetGameSource(GameTargetWPF target, bool reverseME1 = true)
//        {
...
//        {
//            M3Log.Information(@"Validating backup for " + game.ToGameName());
//            var targetPath = BackupService.GetGameBackupPath(game, false);
//            M3Log.Information(@"Backup location: " + targetPath);
...
//            GameTargetWPF target = new GameTargetWPF(game, targetPath, false);
...
//                    }
//                }
//                M3Log.Information(@"Validating backup...");
...
//                    M3Log.Information($@"Wrote {BackupService.CMM_VANILLA_FILENAME} to validated backup");
//                    BackupService.RefreshBackupStatus(game: game);
//                }
//                else
//                {
//                    M3Log.Warning($@"Backup verification has failed for the backup at {target.TargetPath}. This backup will not be used");
//                }
//            }
//            else
//            {
//                M3Log.Information(@"Backup target is invalid. This backup cannot not be used. Reason: " + validationFailedReason);
//            }
