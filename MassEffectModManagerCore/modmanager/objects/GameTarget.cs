...
//            MemoryAnalyzer.AddTrackedMemoryItem($@"{game} GameTargetWPF {TargetPath} - IsCustomOption: {isCustomOption}", new WeakReference(this));
...
//                else
//                {
//                    M3Log.Error($@"Target is invalid: {TargetPath} does not exist (or is not accessible)");
//                    IsValid = false;
//                }
//            }
//            else
...
//        public bool Equals(GameTargetWPF x, GameTargetWPF y)
//        {
//            return x.TargetPath == y.TargetPath && x.Game == y.Game;
//        }

//        public int GetHashCode(GameTargetWPF obj)
//        {
...
//                                {
//                                    M3Log.Warning($@"Sanity check for MEMI extended marker failed. We did not read data until the marker info offset. Should be at 0x{memiExtendedEndPos:X6}, but ended at 0x{fs.Position:X6}");
//                                }
//                            }
...
//                catch (Exception e)
//                {
//                    M3Log.Error($@"Error reading texture mod marker file for {Game}. Installed info will be returned as null (nothing installed). " + e.Message);
//                    return null;
//                }
//            }
...
//            M3Log.Information($@"Validating game target: {TargetPath}");
...
//        protected bool Equals(GameTargetWPF other)
//        {
...
//        {
//            public SFARObject(string file, GameTargetWPF target, Func<string, bool> restoreSFARCallback,
...
//                                {
//                                    M3Log.Information(@"Deleting unpacked file: " + file);
//                                    File.Delete(file);
//                                }
//                            }
...
//                            {
//                                M3Log.Information($@"Restoring SFAR from backup: {backupFile} -> {targetFile}");
...
//            private readonly GameTargetWPF target;
...
//            public ModifiedFileObject(string filePath, GameTargetWPF target,
...
//                    {
//                        Restoring = true;
//                        M3Log.Information(@"Restoring basegame file: " + targetFile);
...
//                        Restoring = false;
//                        notifyRestoredCallback?.Invoke(this);
//                        M3Log.Error($@"Error restoring file {targetFile}: " + e.Message);
//                    }
//                }
//            }
...
//            catch (Exception e)
//            {
//                M3Log.Error($@"Error writing debug texture mod installation marker file: {e.Message}");
//            }
//#endif
//        }
...
//                }
//                M3Log.Information(@"Changed MEMI Tag for game to 1234.");
//            }
//            catch (Exception e)
//            {
//                M3Log.Error($@"Error stripping debug ALOT marker file for {Game}. {e.Message}");
//            }
//#endif
//        }
...
//                    catch (Exception e)
//                    {
//                        M3Log.Error($@"Error deleting extra file {FilePath}: {e.Message}");
//                    }
//                }
//            }
...
//            catch (Exception e)
//            {
//                M3Log.Error($@"Error populating extras for target {TargetPath}: " + e.Message);
//            }
//        }
...
//            catch (Exception e)
//            {
//                M3Log.Error(@"Error fetching list of installed ASIs: " + e.Message);
//            }
