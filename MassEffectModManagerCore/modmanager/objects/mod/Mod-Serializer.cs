    ...
    public partial class Mod : IMDParameterMap, IEquatable<Mod>
    {
        ...
        public void BuildParameterMap(Mod _)
        {
            ...
            parameterDictionary = new Dictionary<string, object>()
            {
                ...
                {MODDESC_DESCRIPTOR_MODINFO_BANNERIMAGENAME, new MDParameter(@"string", MODDESC_DESCRIPTOR_MODINFO_BANNERIMAGENAME, BannerImageName, BannerImageName != null ? new[] {@"", BannerImageName } : new [] {@""}, @"") {Header = MODDESC_HEADERKEY_MODINFO, AllowedValuesPopulationFunc = PopulateImageFileOptions}}, // Uses image population function // do not localize
