...
//        public ObservableCollectionExtended<GameTargetWPF> GameTargets { get; } = new ObservableCollectionExtended<GameTargetWPF>();
...
//        public ASIGame(MEGame game, List<GameTargetWPF> targets)
//        {
//            Game = game;
...
//        public ASIGame(GameTargetWPF target)
//        {
//            Game = target.Game;
...
//        //        {
//        //            M3Log.Information(@"Creating ASI directory: " + destinationDirectory);
...
//        //            {
//        //                M3Log.Information($@"Copying local ASI from library to destination: {cachedPath} -> {finalPath}");
...
//        //        if (b.Error != null)
//        //        {
//        //            M3Log.Error(@"Error occurred in ASI installer thread: " + b.Error.Message);
//        //        }
//        //        RefreshASIStates();
//        //        operationCompletedCallback?.Invoke();
//        //    };
...
//        //    M3Log.Information(@"Deleting installed ASI: " + installedInfo.InstalledPath);
//        //    try
//        //    {
...
//        //    catch (Exception e)
//        //    {
//        //        M3Log.Error($@"Error deleting asi: {e.Message}");
...
//        //    {
//        //        //how can this be?
//        //        M3Log.Error(@"ASI is null for ApplyASI()!");
//        //        return false;
//        //    }
//        //    if (SelectedTarget == null)
//        //    {
//        //        M3Log.Error(@"SelectedTarget is null for ApplyASI()!");
//        //        return false; //prevent crash
//        //    }
//        //    M3Log.Information($@"Installing {asi.Name} v{asi.Version} to target {SelectedTarget.TargetPath}");
...
//        //    //    else
//        //    //    {
//        //    //        M3Log.Information(@"The installed version of this ASI is already up to date.");
//        //    //        return false;
//        //    //    }
//        //    //}
//        //    //else
