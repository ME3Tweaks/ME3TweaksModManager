...
| modver      | Semantic version number                                            | Mod version, as shown in Mod Manager. This value is also used to detect updates. Required for mod deployment and use of the updater service. Mods targetting moddesc 6.0 should ensure it is a semantic version number, in one of the following three formats: X.Y, X.Y.Z, or W.X.Y.Z, where WXYZ are numerals.                                                                                                                                                                                                                                                           | Yes                                          | All                |
