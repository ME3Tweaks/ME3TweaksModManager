...
|addfiles|Unquoted Semicolon Separated List (String)|**This descriptor is deprecated. Use `newfiles` instead.** List of filenames in the moddir that  will be added to this DLC.|if using addfilestargets|4.1+, All games BASEGAME, Official DLC ME3 only|
