...
| DependsOnKeys | PlusMinusKey list of OptionKeys | A list of other alternates to depend on for state changing, separated by a semicolon. Values selected are specified with a prefixed '+', values not selected are prefixed with a '-'. | No | 8.0+ |
